...
function GO_RESULT_SELECTION()
    return GO_RESULT.selection
end
function GO_RESULT_FONT()
    return GO_RESULT.font
end
function GO_RESULT_LOADING()
    return GO_RESULT.loading
end
function GO_RESULT_PREVIEW()
    return GO_RESULT.preview
end
function GO_RESULT_ICONS()
    return json.encode(GO_RESULT.icons)
end
function GO_RESULT_MODEL()
    return json.encode(GO_RESULT.model)
end
function GO_RESULT_SOUND()
    return json.encode(GO_RESULT.sound)
end
function GO_RESULT_PLUGINS()
    return json.encode(GO_RESULT.plugins)
end
function GO_RESULT_UI()
    return json.encode(GO_RESULT.ui)
end
function GO_RESULT_SLK()
