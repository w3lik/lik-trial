...
buff.conf("coolDown", nil, "ability/ShadowLastingAfflictions")
buff.conf("coolDownPercent", nil, "ability/ShadowLastingAfflictions")
buff.conf("castChant", nil, "ability/ShadowLastingAfflictions")
buff.conf("castChantPercent", nil, "ability/ShadowLastingAfflictions")
buff.conf("castKeep", nil, "ability/ShadowLastingAfflictions")
buff.conf("castKeepPercent", nil, "ability/ShadowLastingAfflictions")
buff.conf("castDistance", nil, "ability/ShadowLastingAfflictions")
buff.conf("castDistancePercent", nil, "ability/ShadowLastingAfflictions")
buff.conf("castRange", nil, "ability/ShadowLastingAfflictions")
buff.conf("castRangePercent", nil, "ability/ShadowLastingAfflictions")
buff.conf("cost", nil, "ability/ShadowLastingAfflictions")
buff.conf("costPercent", nil, "ability/ShadowLastingAfflictions")
