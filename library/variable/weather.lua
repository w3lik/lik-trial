...
---@desc 特性1、天气类型非handle类型，[视觉区]指曾看到的区域，是虚构的概念实际上不存在，但可粗略理解为Region
...
---@desc 特性5、同源类型（如迷雾/光束），不能同时显示在同一片视觉区，会被抢先生成的占领视觉区，即使使用不同Region也无效
---@desc 特性6、同一Region，只添加最多1种天气时，此天气添加[迷雾|光束|雨水类型]后，可后续修改为其他[迷雾|光束|雨水类型](但依然遵循 特性5)
---@desc 特性7、同一Region，曾添加过2种以上天气后，则该视觉区在添加1次[迷雾|光束|雨水类型]后，则该视觉区的[其他][迷雾|光束|雨水类型]功能将被废且锁死，无法生效
